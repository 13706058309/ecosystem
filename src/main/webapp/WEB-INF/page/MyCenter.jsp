...
<link href="/xh/images/favicon.ico" rel="Shortcut Icon">
...
<div id="body">
    <div id="header">
        <span ><a href="#tiao">跳转测试4</a></span>
        <div class="wrapper">
            <a class="logo" href="h/">
                <img width="229" height="43" alt="拉勾招聘-专注互联网招聘" src="${pageContext.request.contextPath}/style/images/logo.png">
            </a>
            <ul id="navheader" class="reset">
                <li><a href="index.html">首页</a></li>
                <li><a href="companylist.html">公司</a></li>
                <li><a target="_blank" href="h/toForum.html">论坛</a></li>
                <li class="current"><a rel="nofollow" href="jianli.html">个人中心</a></li>
            </ul>
    ...
    <div id="container">
        ...
        <div class="clearfix">
                ...
                <div class="profile_box" id="basicInfo">
                    ...
                    <div class="basicShow">
                        ...
                        <div class="m_portrait">
                            <div></div>
                            <img width="120" height="120" alt="jason" src="${pageContext.request.contextPath}/style/images/default_headpic.png">
                        </div>
                    </div><!--end .basicShow-->
            ...
            <div class="content_r">
                ...
                <div class="greybg qrcode mt20">
                    <img width="242" height="242" alt="拉勾微信公众号二维码" src="${pageContext.request.contextPath}/style/images/qr_resume.png">
        ...
        <div style="display:none;">
            ...
            <div class="popup" id="uploadFile">
                <table width="100%">
                    ...
                    <tr>
                        <td align="center"><img width="55" height="16" alt="loading" style="visibility: hidden;" id="loadingImg" src="${pageContext.request.contextPath}/style/images/loading.gif"></td>
                    </tr>
                    </tbody></table>
            </div><!--/#uploadFile-->
        ...
        <script src="${pageContext.request.contextPath}/style/js/Chart.min.js" type="text/javascript"></script>
        <script src="${pageContext.request.contextPath}/style/js/profile.min.js" type="text/javascript"></script>
