...
public class AlipayService {
    ...
    public String alipayTradePagePay(HttpServletRequest request , HttpServletResponse response) throws Exception{
        ...
        cerRecordid = Long.parseLong(new String(request.getParameter("cerRecordlastid").getBytes("ISO-8859-1"),"UTF-8"));
        System.out.println("当前id"+cerRecordid);
        ...
        System.out.println("我跳到这里了啊啊啊啊啊啊啊付钱了吗");
        return "certificate/alipay.trade.page.pay";
    }
	...
	*/
    ...
    public String  returnUrl(HttpServletRequest request)throws Exception{
        ...
        if(signVerified) {
            ...
            if (cerRecordid != 0){
                long standid = 22;
                int n = cerRecordService.upcersqstandid(standid,cerRecordid);
            }
